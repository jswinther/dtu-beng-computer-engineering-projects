...
public class main {
	...
	ArrayList<String> tokData = new ArrayList<String>();
	ArrayList<String> argumentList = new ArrayList<String>();
	System.out.println(ast.typeCheck(env, tokData, argumentList));
	System.out.println(ast.compile(env));
//	System.out.println(((Start)ast).compile(new Environment()));
    }
}
